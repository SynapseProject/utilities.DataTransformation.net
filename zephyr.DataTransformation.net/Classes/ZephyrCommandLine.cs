...
public class ZephyrCommandLine
{
    ...
    static void WriteHelpAndExit(string message)
    {
        ...
        ConsoleColor defaultColor = Console.ForegroundColor;
        Console_WriteLine($"zephyr.datatransformation.cli.exe, Version: {typeof(ZephyrCommandLine).Assembly.GetName().Version}\r\n", ConsoleColor.Green);
        Console.WriteLine("Syntax:");
        Console_WriteLine("  zephyr.datatransformation.cli.exe {0}serializationFormat{1} {0}action{1} {0}parameters{1}\r\n", ConsoleColor.Cyan, "{", "}");
        ...
        Console.WriteLine("     zephyr.datatransformation.cli json convert file:c:\\temp\\products.json");
        Console.WriteLine("         outputFormat:yaml\r\n");
        Console.WriteLine("     zephyr.datatransformation.cli json xsltransform file:c:\\temp\\products.json");
        Console.WriteLine("         xslt:c:\\temp\\foo.xslt\r\n");
        Console.WriteLine("     zephyr.datatransformation.cli json jsonselect file:c:\\temp\\products.json");
        Console.WriteLine("        expression:$..Products[?(@.Price >= 50)].Name\r\n");
        Console.WriteLine("     zephyr.datatransformation.cli json regexmatch file:c:\\temp\\products.json");
